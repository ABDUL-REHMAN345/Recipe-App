...
<a href="./recipes.html?${type}=${tag.toLowerCase()}" class="filter-chip label-large has-state">${tag}
</a>
`;
...
<div class="stats-item">
  <span class="display-medium">${getTime(totalTime).time || "<1"}</span>
...
Ingredients
<span class="label-medium">for ${servings} Servings
</span>
</h2>

${ingredientItems ? `<ul class="body-large ingr-list">${ingredientItems}
</ul>` : ""}
  </div>
